...
const cityIndex = city.indexOf("y".toLocaleUpperCase());
console.log(cityIndex); // Output: 4

// 2. Sottostringhe
// Stampa la sottostringa "York" dalla variabile city
const citySubstring = city.slice(city.indexOf("y".toLocaleUpperCase()));
console.log(citySubstring); // Output: "York"

// 3. Sostituzione
// Sostituisci 'York' con 'Delhi'
const cityReplaced = city.replace(
  city.slice(city.indexOf("y".toLocaleUpperCase())),
  "Delhi"
);
